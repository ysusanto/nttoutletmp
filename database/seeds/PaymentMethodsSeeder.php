...
class PaymentMethodsSeeder extends BaseSeeder
{
    ...
    public function run()
    {
        ...
        DB::table('payment_methods')->insert([
            ...
            'description' => 'Midtrans is one of the best and safe option to charge credit and debit cards around the world. Midtrans has a simple fee structure and no hidden costs. No other gateway or merchant account is required. <br/><strong>By using Midtrans: </strong><br/>- You have to connect our platform to your Midtrans account.',
            'admin_description' => 'Midtrans is one of the best and safe option to charge credit and debit cards around the world. Midtrans has a simple fee structure and no hidden costs. No other gateway or merchant account is required. <br/><strong>By using Midtrans: </strong><br/>- You have to connect our platform to your Midtrans account.',
            'admin_help_doc_link' => 'https://docs.midtrans.com/en/payments/overview',
            'order' => 10,
            'enabled'=>1,
            'created_at' => Carbon::Now(),
            'updated_at' => Carbon::Now(),
