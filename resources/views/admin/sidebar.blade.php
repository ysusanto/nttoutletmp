...
<!-- edit by ari 03062021 -->
    ...
    @if(Auth::user()->isAdmin())
    <li class="{{ Request::is('admin/shipping/ShippingCourier*') ? 'active' : '' }}">
      <a href="{{ url('admin/shipping/shippingCourier') }}">
        <i class="fa fa-car"></i> <span>{{ trans('nav.shipping_courier') }}</span>
      </a>
    </li>
    @endif
