    ...
    <div class="col-md-3 col-sm-6 col-xs-12 nopadding-right">
      <div class="info-box">
        ...
        <div class="info-box-content">
          ...
          @php
            $unfulfilled_percents = $todays_order_count == 0 ? $unfulfilled_order_count * 100 : round(($unfulfilled_order_count / $todays_order_count) * 100);
          @endphp
          <div class="progress">
    ...
    <div class="col-md-3 col-sm-6 col-xs-12 nopadding-left">
      <div class="info-box">
        ...
        <div class="info-box-content">
          ...
          @php
            $stock_out_percents = $stock_count > 0 ? round(($stock_out_count / $stock_count) * 100) : $stock_out_count * 100;
          @endphp
          <div class="progress">
                        ...
                        <tr>
                          ...
                          <td>
                            @if ($inventory->offer_price > 0 && $inventory->offer_end > \Carbon\Carbon::now())
                              <?php $offer_price_help = trans('help.offer_starting_time') . ': ' . $inventory->offer_start->diffForHumans() . ' and ' . trans('help.offer_ending_time') . ': ' . $inventory->offer_end->diffForHumans(); ?>
            ...
            <div class="box-body">
              ...
              @php
                switch ($staff_count_percentage) {
                    case $staff_count_percentage > 90:
                        $state = 'red';
                        break;
                    case $staff_count_percentage > 75:
                        $state = 'warning';
                        break;
                    case $staff_count_percentage > 60:
                        $state = 'info';
                        break;
                    default:
                        $state = 'primary';
              ...
              @php
                switch ($stock_used_percentage) {
                    case $stock_used_percentage > 90:
                        $state = 'red';
                        break;
                    case $stock_used_percentage > 75:
                        $state = 'warning';
                        break;
                    case $stock_used_percentage > 60:
                        $state = 'info';
                        break;
                    default:
                        $state = 'primary';
