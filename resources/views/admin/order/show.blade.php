...
<button class="btn btn-link btn-sm trackaction" >Track</button>
@endif
          </div>
<input type="hidden" id="orderIdshipp"value="{!! $order->id !!}">
        </div> <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <div class="col-sm-12">
                  ...
                  <!-- edit by ari 03062021 -->
                    ...
                    <em class="small">
                      @if($courier->parent)
                        {{ $courier->parent }}
                        @php
                          $carrier_name = $courier->name ? $courier->name : null;  
                        @endphp
                        @if($carrier_name)
                            <small> {{  $carrier_name }} </small>
                        @endif
                      @else
    ...
    <div class="col-md-4 nopadding-left">
      ...
      <div class="box">
        ...
        <div class="row">
            ...
            <span>{{ trans('app.tracking_id') }}:<span id='labeltracking'> {{ $order->tracking_id }}</span></span><br/>
            </div>
            <div class="col-md-2 col-sm-2">
            <!-- <span id="spanedittracking"><i class="fa fa-pencil fa-stack-1x"></i></span> -->
            </div>
        </div>
          
          <span>{{ trans('app.carrier') }}: <strong>{{ $courier->parent ? $courier->parent.' ' . $courier->name : '' }}</strong></span><br/>
