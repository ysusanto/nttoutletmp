                ...
                <div class="side-widget" id="cart-summary{{$cart->id}}">
                    ...
                    <ul class="shopping-cart-summary">
                        ...
                        <li>
                            <span>{{ trans('theme.total') }}</span>
                            <span>{{ get_currency_prefix() }}
                                <span id="summary-grand-totals{{$cart->id}}">{{ number_format(0, 2, '.', '') }}</span>{{ get_currency_suffix() }}
                            </span>
                        </li> -->
                    </ul>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 pull-left">
                ...
                <form action="{{ route('oneCheckout.cart') }}" method="post">
                    ...
                    @endforeach
                    <button type="submit" id="checkoutAll" class="btn btn-primary flat pull-right"><i class="fa fa-shopping-cart"></i> {{ trans('theme.single_checkout') }} </button>
                </form>
                @endif
            </div>
        </div>
