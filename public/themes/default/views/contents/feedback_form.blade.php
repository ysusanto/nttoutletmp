      ...
      <div class="col-md-5 nopadding-left">
        ...
        <table class="table bg-light" id="buyer-order-table" name="buyer-order-table">
          <tbody>
              ...
              <td>
                ...
                <div class="product-info">
                  ...
                  @if ($order->shop->feedbacks->count())
                    @include('theme::layouts.ratings', ['ratings' => $order->shop->ratings, 'count' => $order->shop->feedbacks->count()])
                  @else
            ...
            <tr class="order-info-head">
              <td>
                <h5><span>@lang('theme.how_satisfied_you_are')</span></h5>
              </td>
            </tr>
            <tr class="order-body">
              <td>
                ...
                <td>
                  ...
                  <div class="product-info">
                    ...
                    @if ($item->feedbacks->count())
                      @include('theme::layouts.ratings', ['ratings' => $item->ratings, 'count' => $item->feedbacks->count()])
                    @else
                      <span class="text-muted small">@lang('theme.no_reviews')</span>
                    @endif
                  </div>
