              ...
              @if($loop->first)
                ...
                <td rowspan="{{ $loop->count }}" class="order-actions">
                  ...
                  @unless($order->isCanceled())
                    ...
                    @endif
<!-- modify by ari 06062021 -->
                    @if($order->canTrack())
                      <button type="button" id="btntrackorderfr" onclick="getTrackShipping({{ $order->id }})" class="btn btn-black btn-sm btn-block flat">
...
<div class="modal fade" id="listTrackingmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" id="divlistrack">
        ...
      </div>
